<template>
	<div class="detail_preSetUp">
		<current yiji="项目管理" erji="项目立项" sanji="项目立项详情">
		</current>
		<div class="content-wrapper">
			<div class="titlebar">
				<span class="title-text">项目立项详情</span>
				<!-- <el-button type="primary" class="toolBtn" @click="save('ruleForm')">保存</el-button> -->
			</div>
			<div class="add-wrapper">
					...
					<el-col :span='24'>
				  		<el-form-item label="项目说明">
							<el-input
							  ...
							  placeholder="请输入内容"
							  v-model="ruleForm.xiangmuRemark">
							</el-input>
					  	</el-form-item>
				  	</el-col>
				</el-form>
				...
				<el-col :span="12" class="item-title"><el-button class="setUp-info-button">查看立项申请文件</el-button></el-col>
