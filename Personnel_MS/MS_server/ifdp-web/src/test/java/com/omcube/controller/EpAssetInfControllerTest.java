...
public class EpAssetInfControllerTest {
	...
	String result = mockMvc.perform(get("/EpAssetInf/queryEpAssetInf/10010000001")
		.contentType(MediaType.APPLICATION_JSON_UTF8))
		.andExpect(status().isOk()).andReturn().getResponse()
		.getContentAsString();
	System.out.println(result);
	...
	String result = mockMvc.perform(put("/EpAssetInf/updateEpAssetInf")
		.param("assetNo", "10010000001")
		.param("organNo", "1001")
		.param("derpNo", "12312")
		.param("applyUserNo", "P0000004")
		.param("buyApplyNo", "1341341352")
		.param("buyUnitPrice", "400")
		.param("buyNum", "5")
		.param("stockNum", "5")	
		.param("buyAmount", "2000")
		.param("mfrs", "格力1集团")
		.param("supplier", "生活1超市")
		.param("assetType", "电1")
		.param("assetName", "格力1空调")
