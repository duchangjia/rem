...
//		Date updatedDate  = dateformat.parse("2017-09-26");
		...
		billInfoPO.setOrganName("深圳平安");
		billInfoPO.setOrganTaxNo("8888");
		billInfoPO.setOrganTel("123456");
		billInfoPO.setOrganAcct("66666666");
		billInfoPO.setOrganAcctname("平安02");
...
//		billInfoPO.setUpdatedDate(updatedDate);	
	...
	@Cacheable
	public Object quetyBillInfoList(@PathVariable String uId,HttpServletRequest request,Integer pageNum,Integer pageSize){
	...
	@Cacheable
	public Object queryBillInfoByName(@PathVariable String uId,@PathVariable String organName,HttpServletRequest request,Integer pageNum,Integer pageSize){
		pageNum = pageNum == null ? 1:pageNum;
		pageSize = pageSize == null ? 5:pageSize;
		PageHelper.startPage(pageNum,pageSize,true);
