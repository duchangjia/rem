...
public class InsurancePayTemplateService {
	...
	public void updateINsurancePayTemplate(InsurancePayTemplatePO insurancePayTemplate) {
		logger.info("uId为" + insurancePayTemplate.getuId() + ",用户编号为" + insurancePayTemplate.getApplyNo() + "准备修改编号为"
				+ insurancePayTemplate.getApplyNo() + "的保险缴纳模板");
		insurancePayTemplateMapper.updateInsurancePayTemplate(insurancePayTemplate);
		logger.info("uId为" + insurancePayTemplate.getuId() + ",用户编号为" + insurancePayTemplate.getApplyNo() + "成功修改了编号为"
				+ insurancePayTemplate.getApplyNo() + "的保险缴纳模板");
	}
