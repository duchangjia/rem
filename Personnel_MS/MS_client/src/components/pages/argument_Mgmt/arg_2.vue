    ...
    <div class="argument_2">
        ...
        <el-col :span="24">
            <div class="content-wrapper">
                ...
                <div class="content">
                    <el-row type="flex" justify="space-around" v-for="(content, index) in contents">
                        <el-col :span="6" v-for="(obj, index2) in content">
...
<style>
    ...
    .content-wrapper .content .item img{
        vertical-align: middle;
        margin-right: 30px;
    }
    .content-wrapper .content .item span{
